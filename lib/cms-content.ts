...
const defaultSolutionItems: NewsItem[] = [
  { title: "标准版", action: "培训赋能", image: dataImage, href: "/solution-standard", summary: "建立核算认知与方法基础" },
  { title: "实战营", action: "Excel单公司版", image: excelImage, href: "/solution-practical", summary: "完成首次温室气体核算闭环" },
  { title: "咨询版", action: "Excel集团版", image: dataImage, href: "/solution-consulting", summary: "建立集团统一核算管理体系" },
  { title: "平台版", action: "数字化升级", image: platformImage, href: "/solution-platform", summary: "建设持续运营的碳管理能力" }
];
...
export const defaultHomeContent: HomeContent = {
  ...
  timeline: [
    { year: "01", items: ["标准版", "培训赋能", "建立温室气体核算认知与方法"] },
    { year: "02", items: ["实战营", "Excel单公司版", "完成首次核算闭环"] },
    { year: "03", items: ["咨询版", "Excel集团版", "建立集团统一核算管理体系"] },
    { year: "04", items: ["平台版", "数字化升级", "建设持续运营的碳管理能力"] }
  ],
...
export const defaultSubpages: Subpage[] = normalizeSubpagesContent([
  { slug: "solution-standard", navLabel: "标准版（培训赋能）", eyebrow: "SOLUTION 01", title: "帮助企业快速掌握温室气体核算方法", summary: "适用于初步启动核算、缺少专业人员、方法认知不足或需要统一口径的企业。", image: excelImage, icon: "users", metrics: [{ label: "能力阶段", value: "认知建立" }, { label: "核心成果", value: "实操课程" }, { label: "适用方式", value: "培训" }], features: ["GHG Protocol方法培训", "ISO 14064-1基础培训", "GB/T 32150标准培训", "Excel实战演练与案例解析"], steps: ["识别培训对象与目标", "统一核算边界和口径", "开展标准与工具培训", "形成独立核算能力"] },
  { slug: "solution-practical", navLabel: "实战营（Excel单公司版）", eyebrow: "SOLUTION 02", title: "帮助企业完成首次核算闭环", summary: "通过数据采集梳理、Excel工具部署、实操辅导与过程校核，形成标准化温室气体核算成果。", image: excelImage, icon: "chart", metrics: [{ label: "适用组织", value: "单公司" }, { label: "交付工具", value: "Excel" }, { label: "核心目标", value: "核算闭环" }], features: ["数据采集台账梳理", "Excel单公司版部署", "多年度数据持续积累", "范围一、范围二、范围三核算"], steps: ["梳理核算边界", "采集并校核活动数据", "配置排放因子与口径", "交付核算报表"] },
  { slug: "solution-consulting", navLabel: "咨询版（Excel集团版）", eyebrow: "SOLUTION 03", title: "建立集团统一核算管理体系", summary: "面向多法人、多层级组织，支持子公司独立核算、集团自动汇总和统一核算口径。", image: dataImage, icon: "building", metrics: [{ label: "适用组织", value: "集团" }, { label: "数据结构", value: "统一" }, { label: "汇总方式", value: "自动" }], features: ["子公司独立核算", "集团自动汇总", "统一数据结构与核算口径", "支撑ESG披露与供应链要求"], steps: ["梳理集团组织边界", "建立统一标准体系", "部署分子公司核算工具", "汇总复核并持续运营"] },
  { slug: "solution-platform", navLabel: "平台版（数字化升级）", eyebrow: "SOLUTION 04", title: "建设企业长期碳管理能力", summary: "以统一数据体系和集中核算引擎为核心，实现自动化核算、多维分析、结果追溯和持续数据沉淀。", image: platformImage, icon: "sparkles", metrics: [{ label: "标准体系", value: "3类" }, { label: "功能模块", value: "9大" }, { label: "分析图表", value: "50+" }], features: ["GHG Protocol、ISO 14064-1、GB/T 32150-2025多标准核算", "一次核算沉淀四类关键数据成果", "基准年管理与排放趋势分析", "数据全链路可追溯、可复查"], steps: ["业务与需求分析", "核算边界与标准体系确认", "数据模型及因子体系构建", "平台部署、核算验证与持续运营"] },
  ...
  { slug: "customer-cases", navLabel: "客户案例", eyebrow: "CASES", title: "按能力阶段沉淀项目实践", summary: "案例内容按培训赋能、Excel单公司版、Excel集团版和数字化平台四类交付形态组织，便于企业对照自身阶段选择建设路径。", image: dataImage, icon: "building", metrics: [{ label: "案例分类", value: "4类" }, { label: "交付路径", value: "标准化" }, { label: "价值重点", value: "可持续" }], features: ["培训赋能案例", "Excel单公司版案例", "Excel集团版案例", "数字化平台案例"], steps: ["项目背景与问题诊断", "建设内容与实施过程", "建设成果复核", "客户价值总结"] },
