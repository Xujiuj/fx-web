...
const pageComponents: Record<SubpageLayout, React.ComponentType<{ page: Subpage; knowledgeEntries?: KnowledgeEntry[] }>> = {
...
export function SubpageShell({ page, knowledgeEntries }: { page: Subpage; knowledgeEntries?: KnowledgeEntry[] }) {
  ...
  return (
    ...
    >
      <PageComponent page={page} knowledgeEntries={knowledgeEntries} />
    </main>
  );
}
